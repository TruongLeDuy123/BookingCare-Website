...
class UserRedux extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        // render => didupdate
        // hiện tại(this)([3]) và quá khứ(prev)([])

        // ([3]) ([3])
        if (prevProps.genderRedux !== this.props.genderRedux) {
            let arrGenders = this.props.genderRedux
            // console.log("check arrGender: ",arrGenders);
            this.setState({
    ...
    render() {
        ...
        // console.log("truong check state: ", this.state);
                    ...
                    <div className='container'>
                        <div className='row'>
                            ...
                            <div className='col-3'>
                                ...
                                <input className="form-control" type='email' value={email} onChange={(e) => this.onChangeInput(e, 'email')}
                                    disabled={this.state.action === CRUD_ACTIONS.EDIT ? true: false}
                                />
                            </div>
                            <div className='col-3'>
                                <label><FormattedMessage id="manage-user.password" /></label>
                                <input className="form-control" type='password' value={password} onChange={(e) => this.onChangeInput(e, 'password')} 
                                    disabled={this.state.action === CRUD_ACTIONS.EDIT ? true: false}
                                />
                            </div>
                            <div className='col-3'>
