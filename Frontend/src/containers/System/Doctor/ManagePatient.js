...
class ManagePatient extends Component {
    ...
    getDataPatient = async () => {
        ...
        console.log("CHECK RES GET ALL PATIENT: ", res);
    ...
    handleBtnConfirm = (item) => {
        ...
        console.log("CHECK BTN CONFIRM: ", item);
    }
    ...
    sendRemedy = async (dataChildModal) => {
        // console.log("PARENT CHECK: ", dataChildModal);
        let { dataModal, isOpenRemedyModal } = this.state
        this.setState({
            isShowLoading: true
        })
        ...
        console.log("CHECK SEND REMEDY: ", res);
        if (res && res.errCode === 0) {
            this.setState({
                isShowLoading: false
            })
