...
class ManageSchedule extends Component {
    ...
    handleOnChangeDatePicker = (date) => {
        ...
        // console.log("truong check change datepicker: ", date);
    }
    ...
    handleClickBtnTime = (time) => {
        ...
        if (rangeTime && rangeTime.length > 0) {
            ...
            console.log("check time choose: ", rangeTime);
            this.setState({
                rangeTime: rangeTime
            })
        }
    ...
    handleSaveSchedule = async () => {
        ...
        if (res && res.errCode === 0) {
            toast.success("SaveBulkScheduleDoctor success!")
    ...
    render() {
        ...
        console.log("check state range time: ", rangeTime);
        return (
                        ...
                        <div className='col-12 pick-hour-container'>
                            {rangeTime && rangeTime.length > 0 &&
                                rangeTime.map((item, index) => {
                                    return (
                                        <button key={index} className={item.isSelected === true ? 'btn btn-schedule active' : 'btn btn-schedule'} onClick={() => this.handleClickBtnTime(item)}>
